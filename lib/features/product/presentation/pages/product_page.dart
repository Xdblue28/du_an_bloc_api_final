...
class _ProductPageState extends State<ProductPage> {
  ...
  void initState() {
    super.initState();
    context.read<ProductCubit>().loadProduct(categoryId: null);
  }

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 114, 38, 38),
  ...
  Widget _buildDrawer(BuildContext context) {
    return Drawer(
      child: Column(
        ...
        children: [
          const DrawerHeader(
            decoration: BoxDecoration(color: Color.fromARGB(255, 151, 51, 51)),
            child: Text(
              'Bộ Lọc Danh Mục',
              style: TextStyle(
                color: Colors.white,
          ...
          ListTile(
            ...
            onTap: () {
              context.read<ProductCubit>().loadProduct(categoryId: 25);
              Navigator.pop(context);
            },
          ),
          ListTile(
            ...
            onTap: () {
              context.read<ProductCubit>().loadProduct(categoryId: 24);
              Navigator.pop(context);
            },
          ),
        ],
                    ...
                    Row(
                      ...
                      children: [
                        IconButton(
                          ...
                          onPressed: () async {
                            final mainCubit = context.read<ProductCubit>();
    ...
    return FloatingActionButton(
      onPressed: () async {
        ...
        await Navigator.push(
          ...
          MaterialPageRoute(
            builder: (_) =>
                BlocProvider.value(value: mainCubit, child: AddproductPage()),
          ),
        );
        mainCubit.loadProduct(categoryId: null);
      },
